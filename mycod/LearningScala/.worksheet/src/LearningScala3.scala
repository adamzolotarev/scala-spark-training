object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def upperIt(in: String): String = {
		in.toUpperCase()
  };System.out.println("""upperIt: (in: String)String""");$skip(19); val res$3 = 
  	upperIt("asdf");System.out.println("""res3: String = """ + $show(res$3));$skip(92); 
  	
  	def transformThisString(in: String, f: String => String) : String = {
  		f(in)
  	};System.out.println("""transformThisString: (in: String, f: String => String)String""");$skip(46); val res$4 = 
  	
  	transformThisString("qwerty", upperIt);System.out.println("""res4: String = """ + $show(res$4));$skip(55); val res$5 = 
  	transformThisString("qwerty", x => x.toUpperCase());System.out.println("""res5: String = """ + $show(res$5))}
}
