object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(131); 
  // VALUES are immutable constants. You can't change them once defined.
  val hello: String = "Holadasdf!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  val doublePi: Double = pi * 2;System.out.println("""doublePi  : Double = """ + $show(doublePi ));$skip(41); 
  println(f"Double Pi is $doublePi%.3f")}
