object LearningScala1 {
  ...
  val hello: String = "Holadasdf!"                //> hello  : String = Holadasdf!
  println(hello)                                  //> Holadasdf!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Holadasdf!
  helloThere = hello + " There!"
  println(helloThere)                             //> Holadasdf! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Holadasdf!There!
  println(immutableHelloThere)                    //> Holadasdf!There!
  ...
  println(f"Double Pi is $doublePi%.3f")          //> Double Pi is 6.283
